...
$dir = "C:\Users\adflab\Desktop\ADFLAB"     #Working directory of where your LabDeploy.ps1 file is located
$resourceGroupName = "adflab-ready"         #Name of Azure resource group to deploy the lab resrouces to, will create if it does not exist
...
$logicAppEmail = "youremail@microsoft.com" #O365 Account to send emails for lab
...
Invoke-Sqlcmd -inputFile "CreateTablesDW.sql" -ServerInstance "$sqlServerName.database.windows.net" -Database "AirlinePerformance-DW" -Username $sqlUsername -Password $sqlPassword
